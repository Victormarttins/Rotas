...
export default function HomePage() {
 const [markers, setMarkers] = useState([]);
  ...
  const [markerDescription, setMarkerDescription] = useState<PontoEntity>();
  ...
  const [atualImage, setAtualImage] = useState(null);
    ...
    return (
      //inciando o valor do mapa e passando a latitude e logetude da localização exata\\
      ...
      <View style={styles.container}>
        {currentLocation ? (
          ...
          >
          //passando o mapa e puxando a coordenada\\
            {markers.map((marker) => (
        ...
        <ModalComponent
          ...
          deleteMarker={() => {
            const updatedMarker = markers.filter((item) => item.id !== atualImage?.id);
